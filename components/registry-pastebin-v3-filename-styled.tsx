...
/**
 * VARIANT 3: Filename with enhanced visual styling
 * Keeps filename at the bottom but makes it look more like an editable input
 * with border, focus ring, and clearer hover states
 */

import { useState, useRef, useEffect } from "react"
import { useRouter } from "next/navigation"
import Link from "next/link"
import { ChevronDown, Loader2, Code2, Plus, Lock, RefreshCw, Copy, Check, Pencil } from "lucide-react"
...
export function RegistryPastebinV3() {
      ...
      <div className="flex-1 container mx-auto px-4 pt-12 md:pt-20 pb-8 flex flex-col">
        <div className="flex-1 flex flex-col max-w-3xl mx-auto w-full">
          <div className="text-center mb-8">
            ...
            <p className="text-xs text-amber-600 mt-2">VARIANT 3: Enhanced visual styling</p>
          </div>
              ...
              return (
                <div key={file.id} className="flex flex-col">
                  ...
                  <InputGroup className="flex-1 flex flex-col min-h-[300px]">
                    {/* Top Bar with Type and Language */}
                    ...
                    {/* VARIANT 3: Enhanced visual styling for filename */}
                    <InputGroupAddon align="block-end" className="border-t bg-muted/30">
                      <div className="flex items-center gap-3 w-full py-1">
                        <div className="flex items-center gap-1.5 text-muted-foreground">
                          <Pencil className="h-3.5 w-3.5" />
                          <span className="text-xs font-medium">Save as:</span>
                        </div>
                        <div className="flex-1 flex items-center gap-0 rounded-md border border-input bg-background hover:border-ring focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-1 transition-all">
                          <span className="px-2 py-1.5 text-xs text-muted-foreground font-mono bg-muted/50 rounded-l-md border-r">
                          ...
                          <input
                            ...
                            placeholder={
                              files.length > 1
                                ...
                                : `${fileTypeConfig.placeholder} (optional)`
                            }
                            className="flex-1 px-2 py-1.5 bg-transparent border-none outline-none font-mono text-sm placeholder:text-muted-foreground/50"
                            disabled={isUploading}
