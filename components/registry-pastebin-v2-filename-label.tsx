...
/**
 * VARIANT 2: Filename with explicit label (similar to Type/Language)
 * Keeps filename at the bottom but adds a clear "Filename:" label with icon
 */
...
export function RegistryPastebinV2() {
      ...
      <div className="flex-1 container mx-auto px-4 pt-12 md:pt-20 pb-8 flex flex-col">
        <div className="flex-1 flex flex-col max-w-3xl mx-auto w-full">
          <div className="text-center mb-8">
            ...
            <p className="text-xs text-amber-600 mt-2">VARIANT 2: Filename with label at bottom</p>
          </div>
              ...
              return (
                <div key={file.id} className="flex flex-col">
                  ...
                  <InputGroup className="flex-1 flex flex-col min-h-[300px]">
                    ...
                    {/* VARIANT 2: Filename with explicit label */}
